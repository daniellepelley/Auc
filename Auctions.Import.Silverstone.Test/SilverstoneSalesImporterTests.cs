...
namespace Auctions.Import.Silverstone.Test
{
    public class SilverstoneSalesImporterTests
    {
        ...
        private static AuctionSale[] GetSales(string htmlFile = "/Html/SalesList.txt")
        {
            ...
            var webScraper = new SilverstoneSalesWebDataImporter(mockHtmlLoader.Object, new DocumentBuilder());

            var sut = new AuctionSalesDataImporter<SilverstoneSale>(webScraper, new SilverstoneSalesMapper());
